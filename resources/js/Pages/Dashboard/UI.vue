    ...
    <layout>
        ...
        <base-panel class="mt-4">
            ...
            <div class="mt-4">
                ...
                <button class="px-3 py-1 bg-indigo-500 hover:bg-indigo-600 text-white font-medium rounded">Primary
                </button>
                <button class="px-3 py-1 bg-green-500 hover:bg-green-600 text-white font-medium rounded">Success
                </button>
                ...
                <button class="px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-medium rounded">Success lg
                </button>
