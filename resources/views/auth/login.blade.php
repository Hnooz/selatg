...
@section('content')
    <div class="flex items-center min-h-screen">
        <div class="w-full max-w-lg mx-auto overflow-hidden bg-white rounded-lg shadow">
            <div class="px-6 py-4">
                <div class="flex justify-center text-3xl font-bold text-green-600">
                ...
                <div class="mt-1 text-xl font-bold text-center text-green-600">مرحبا بعودتك</div>
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <button type="submit"
                                class="px-4 py-2 text-white bg-green-600 rounded focus:outline-none hover:bg-green-500">
                            تسجيل دخول
                        </button>
                    </div>
                </form>
